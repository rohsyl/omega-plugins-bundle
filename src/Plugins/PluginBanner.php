...
class PluginBanner extends Plugin
{
    ...
    private function createForm() {
        ...
        $this->makeForm(function(PluginFormFactory $builder) {
            ...
            $builder->entry('background_image', TextSimple::class, null, 'Background image', null, 2, false);
            $builder->entry('action_url', TextSimple::class, null, 'Action', null, 3, false);
            $builder->entry('action_label', TextSimple::class, null, 'Background image', 'This is the label of the button, if empty the button is not displayed.', 4, false);
        });
